const translations = {
  en: {
    ...
    'lernweg.b2': '<strong>Scope:</strong> Authored the full 34-page regulatory proposal and companion Business Plan covering cantonal authorisation, pedagogical model, governance, financial projections, and investor strategy, targeting CHF 1.5 million establishment capital and operating break-even by Year 3.',
    ...
    'edu.tab.core':       'Core Board Credentials',
    'edu.tab.swiss':      'Swiss & European CAS',
    'edu.tab.academic':   'Postgraduate Foundations',
    'edu.year.certified': 'Certified',
    'edu.fhgr':           'University of Applied Sciences of the Grisons (FHGR)',
    'edu.tab.credly':     'Credly Badge Wallet',
    'badge.pmi':          'Project Management Institute',
    'badge.agile.title':  'Agile Metrics for Success',
    'badge.agile.date':   'Issued Jan 7, 2026',
    'badge.data.title':   'Data Landscape of GenAI for Project Managers',
    'badge.data.date':    'Issued Apr 25, 2025',
    'badge.genai.title':  'Generative AI Overview for Project Managers',
    'badge.genai.date':   'Issued May 28, 2024',
    'badge.cog.title':    'Introduction to Cognitive Project Management in AI (CPMAI)™',
    'badge.cog.date':     'Issued May 2, 2025',
    'badge.citizen.title': 'PMI Citizen Developer™ Practitioner Skills',
    'badge.citizen.date':  'Issued Apr 23, 2025',
    'badge.seven.title':  'PMI® Essentials: Seven AI Project Patterns',
    'badge.seven.date':   'Issued May 18, 2026',
    'badge.prac.title':   'Practical Application of Gen AI for Project Managers',
    'badge.prac.date':    'Issued Apr 30, 2025',
    'badge.pmp.title':    'Project Management Professional (PMP)®',
    'badge.pmp.date':     'Expires Apr 17, 2030',
    'badge.prompt.title': 'Talking to AI: Prompt Engineering for Project Managers',
    'badge.prompt.date':  'Issued Apr 28, 2025',
    'badge.value.title':  'Value Stream Management',
    'badge.value.date':   'Issued Aug 21, 2025',
    ...
    'skills.technical':   'Technical Skills & Analytics',
    'skills.competencies':'Program Architecture & Systems',
    'skills.ai':          'Artificial & Generative AI',
    'skills.languages':   'Languages & Alignment',
    'skills.swiss.compliance': 'Swiss School Compliance',
    'skills.lehrplan':    'Lehrplan 21 / HarmoS',
    'skills.refugee':     'Refugee Integration',
    'lang.english.level': 'English (Fluent)',
    ...
    'contact.booking.title': 'Schedule a Consultation',
    'contact.booking.subtitle': 'Select an engagement method below to connect instantly',
    'contact.slot1.title': '15-Min Strategic Discovery Call',
    'contact.slot1.desc': 'Ideal for scoping initial M&E and project needs',
    'contact.slot2.title': 'Detailed Proposal Request',
    'contact.slot2.desc': 'Request pricing, compliance analysis, or timeline terms',
    'contact.book': 'Book Call',
    ...
    // Footer
    'footer.tagline':  'PMP® | M&E Consultant | Data Analytics | Public Health',
    ...
    'exp.7.desc':  `<li><strong>Community Mobilisation:</strong> Facilitated field workshops and coordinated regional community mobilization for agricultural development.</li>
                    <li><strong>Coordination & Reporting:</strong> Coordinated project timelines, tracked deliverables, and generated field reports for USAID project directors.</li>`,
    
    'exp.8.title': 'Accounts Assistant',
    'exp.8.desc':  `<li><strong>Financial Control:</strong> Administered daily financial reconciliation, managed cash flows, and prepared monthly expenditure ledgers.</li>
                    <li><strong>Compliance Auditing:</strong> Guaranteed strict alignment with Save the Children UK financial systems and international donor requirements.</li>`,
    ...
    'research.desc.5':  'Investigates how community-level socio-cultural factors affect M&E uptake in malaria initiatives. Results reveal that while general attitudes have no significant impact, specific cultural beliefs (β = .116) and local decision-making power (β = .232) are major determinants, highlighting the need for targeted community sensitization.',
    'research.desc.6':  'Examination of key determinants influencing M&E findings uptake in malaria program implementation',
    'research.desc.7':  'Investigates the impact of project implementation variables on M&E utilization in Uganda\'s malaria initiatives. Multiple regression analysis of 120 personnel reveals that while evaluation quality, capacity, and communication have insignificant effects, reporting timeliness is the primary significant driver of results utilization, highlighting a critical operational bottleneck.',
    'research.desc.8':  'Examines organization-level decision-making characteristics influencing M&E utilization. Findings indicate that while manager receptiveness and information needs are not significant factors, the structural characteristics of the decisions themselves are the primary drivers of evaluation utilization.',
    ...
    'research.desc.11': 'Qualitative study utilizing interviews with industry experts to examine how digital marketing strategies influence market penetration and business growth in Uganda\'s insurance sector.',
    ...
    'capability.differentiators.list':'<li><strong>PMP® Certified:</strong> Disciplined project management and Agile execution.</li><li><strong>Multilingual:</strong> English, German (B2), Swahili, and 10 African languages.</li><li><strong>Evidence-Based:</strong> Published researcher in peer-reviewed public health and digital marketing journals.</li><li><strong>Cross-Cultural Advisory:</strong> Broad international experience coordinating programs across diverse settings.</li>',
    ...
    'capability.pos.title':           'PERRY GAMBA, PMP®',
    'capability.pos.subtitle':        'Senior International Development, Evidence Systems & Education Advisor',
    'capability.about.p1':            'PMP®-certified consultant with 15+ years of experience helping governments, NGOs, educational institutions, and international organisations improve performance through evidence systems, data analytics, programme leadership, and regulatory compliance.',
    'capability.about.p2':            'I have designed and implemented national monitoring and evaluation systems, led public health and social development programmes, conducted impact evaluations, and advised private education initiatives in Switzerland.',
    'capability.about.p3':            'My work combines strategic planning, data-driven decision-making, and organisational development to strengthen accountability, improve outcomes, and support sustainable growth.',
    'capability.practice.title':      'Consulting Practice Areas',
    'capability.practice.1.title':    'Evidence Systems & Monitoring Architecture',
    'capability.practice.1.desc':     'Design and implementation of monitoring, evaluation, reporting, and learning systems for governments, NGOs, donor-funded programmes, and educational institutions.',
    'capability.practice.1.deliv':    'Deliverables: M&E Frameworks, KPI Architecture, Indicator Catalogues, Reporting Systems, Data Quality Frameworks, Dashboards',
    'capability.practice.2.title':    'Data Analytics & Performance Intelligence',
    'capability.practice.2.desc':     'Transforming organisational data into actionable insight for leadership and decision-making.',
    'capability.practice.2.deliv':    'Deliverables: Performance Dashboards, Data Audits, Statistical Analysis, Data Visualisation, Reporting Automation',
    'capability.practice.3.title':    'Programme Evaluation & Impact Assessment',
    'capability.practice.3.desc':     'Independent assessments of programme effectiveness using quantitative and qualitative methodologies.',
    'capability.practice.3.deliv':    'Deliverables: Baseline Studies, Mid-Term Evaluations, End-Line Evaluations, Impact Assessments, Learning Reviews',
    'capability.practice.4.title':    'Education Development & Regulatory Compliance',
    'capability.practice.4.desc':     'Advisory support for private schools and educational initiatives navigating Swiss regulatory and operational requirements.',
    'capability.practice.4.deliv':    'Deliverables: Permit Applications, Compliance Audits, Governance Frameworks, Lehrplan 21 Alignment, Strategic Development Plans',
    'capability.practice.5.title':    'Project & Programme Leadership',
    'capability.practice.5.desc':     'PMP®-aligned project and programme management services.',
    'capability.practice.5.deliv':    'Deliverables: Programme Design, Implementation Support, Stakeholder Coordination, Risk Management, Performance Monitoring',
    'capability.sectors.title':       'Client Sectors',
    'capability.sectors.list':        '<li>Government Ministries</li><li>International Organisations</li><li>NGOs & Foundations</li><li>Public Health Programmes</li><li>Educational Institutions</li><li>Private Schools</li><li>Refugee & Integration Programmes</li><li>Community Development Initiatives</li>',
    'capability.snapshot.title':      'Impact Snapshot',
    'capability.snapshot.metric1.lbl': 'Years Experience',
    'capability.snapshot.metric2.lbl': 'Health Facilities Supported',
    'capability.snapshot.metric3.lbl': 'Professionals Trained',
    'capability.snapshot.metric4.lbl': 'Performance Improvement Achieved',
    'capability.snapshot.metric5.lbl': "Master's Degrees",
    'capability.snapshot.metric6.lbl': 'Continents Served',
    'capability.snapshot.metric7.lbl': 'Private School Founded',
    'capability.engagements.title':    'Recent Advisory Engagements',
    'capability.engagements.lernweg.title': 'LernWeg Primarschule (Founder & Strategic Lead)',
    'capability.engagements.lernweg.desc': '<li>School concept development</li><li>Governance design</li><li>Financial modelling</li><li>Regulatory planning</li>',
    'capability.engagements.lebeort.title': 'Trägerverein LebeORT Innerthal',
    'capability.engagements.lebeort.desc': '<li>Education compliance review</li><li>Regulatory gap analysis</li><li>Permit resubmission strategy</li>',
    'capability.engagements.eastafrica.title': 'Switzerland–East Africa School Partnerships',
    'capability.engagements.eastafrica.desc': '<li>Programme coordination</li><li>Monitoring framework design</li><li>Impact reporting</li>',
    'capability.credentials.title':   'Qualifications & Credentials',
    'capability.credentials.cert.title': 'Professional Certifications',
    'capability.credentials.cert.list': '<li><strong>PMP®</strong> – Project Management Institute</li><li><strong>Harvard CORe</strong> – Business School Credentials</li><li><strong>CAS Big Data Analysis</strong> – Applied Data Science</li><li><strong>CAS Nutritional Crises</strong> – Public Health Response</li><li><strong>USAID Systematic Reviews</strong> – Evidence Methods</li>',
    'capability.credentials.acad.title': 'Academic Qualifications',
    'capability.credentials.acad.list': '<li><strong>MSc Data Analytics</strong></li><li><strong>MSc Public Health</strong> (International Health)</li><li><strong>Master\'s in Project Monitoring & Evaluation</strong></li><li><strong>Executive Diploma in Advanced Research</strong></li><li><strong>Bachelor of Business Administration</strong></li>',
    'capability.publications.title':  'Selected Publications & Research',
    'capability.publications.1.title': 'Socio-structural and individual factors shaping HIV disclosure decisions',
    'capability.publications.1.desc':  'Peer-reviewed study examining decision-making models in community-based public health programs.',
    'capability.publications.2.title': 'Digital Marketing Innovation in Emerging Economies: Insurance Sector',
    'capability.publications.2.desc':  'Comprehensive study examining how digital channels overcome market barriers and optimize customer engagement.',
    'capability.publications.3.title': 'Timeliness as the Key Driver of M&E Utilization in malaria initiatives',
    'capability.publications.3.desc':  'Regression analysis of project variables influencing the implementation and adoption of M&E findings.',
    'capability.publications.4.title': 'Decision-making characteristics influencing M&E utilization',
    'capability.publications.4.desc':  'Organizational analysis showing how decision structures shape evaluation outcomes in public programs.',
    'capability.references.desc':     'Professional references available upon request.',
    'capability.connect.title':       'Connect',
    'capability.connect.website':     'Website',
    'capability.connect.linkedin':    'LinkedIn',
    'capability.connect.email':       'Email',
  },
  ...
  de: {
    ...
    'about.h2':       'Evidenzbasierte Wirkung',
    ...
    'lernweg.b2': '<strong>Umfang:</strong> Verfassung des vollständigen 34-seitigen Bewilligungsantrags und des Businessplans zu kantonaler Bewilligung, Pädagogik, Governance, Finanzplanung und Investorenstrategie, mit Ziel eines Gründungskapitals von CHF 1,5 Millionen und operativer Kostendeckung bis Jahr 3.',
    ...
    'edu.tab.core':       'Kernkompetenzen',
    'edu.tab.swiss':      'Schweizer & Europäische CAS',
    'edu.tab.academic':   'Postgraduale Grundlagen',
    'edu.year.certified': 'Zertifiziert',
    'edu.fhgr':           'Fachhochschule Graubünden (FHGR)',
    'edu.tab.credly':     'Credly Badge-Wallet',
    'badge.pmi':          'Project Management Institute',
    'badge.agile.title':  'Agile Metrics for Success',
    'badge.agile.date':   'Ausgestellt 7. Jan. 2026',
    'badge.data.title':   'Data Landscape of GenAI for Project Managers',
    'badge.data.date':    'Ausgestellt 25. Apr. 2025',
    'badge.genai.title':  'Generative AI Overview for Project Managers',
    'badge.genai.date':   'Ausgestellt 28. Mai 2024',
    'badge.cog.title':    'Introduction to Cognitive Project Management in AI (CPMAI)™',
    'badge.cog.date':     'Ausgestellt 2. Mai 2025',
    'badge.citizen.title': 'PMI Citizen Developer™ Practitioner Skills',
    'badge.citizen.date':  'Ausgestellt 23. Apr. 2025',
    'badge.seven.title':  'PMI® Essentials: Seven AI Project Patterns',
    'badge.seven.date':   'Ausgestellt 18. Mai 2026',
    'badge.prac.title':   'Practical Application of Gen AI for Project Managers',
    'badge.prac.date':    'Ausgestellt 30. Apr. 2025',
    'badge.pmp.title':    'Project Management Professional (PMP)®',
    'badge.pmp.date':     'Gültig bis 17. Apr. 2030',
    'badge.prompt.title': 'Talking to AI: Prompt Engineering for Project Managers',
    'badge.prompt.date':  'Ausgestellt 28. Apr. 2025',
    'badge.value.title':  'Value Stream Management',
    'badge.value.date':   'Ausgestellt 21. Aug. 2025',
    ...
    'skills.subtitle':    'Technische und berufliche Kompetenzen',
    'skills.technical':   'Datenanalyse & IT-Systeme',
    'skills.competencies':'Programm-Architektur & M&E',
    'skills.ai':          'Künstliche & Generative KI',
    'skills.languages':   'Sprachen & Stakeholder-Alignment',
    'skills.swiss.compliance': 'Schweizer Schul-Compliance',
    'skills.lehrplan':    'Lehrplan 21 / HarmoS',
    'skills.refugee':     'Flüchtlingsintegration',
    'lang.english.level': 'Englisch (Fliessend)',
    ...
    'contact.subtitle': 'Lassen Sie uns an Ihrem nächsten Projekt zusammenarbeiten',
    'contact.email':    'E-Mail',
    'contact.phone':    'Telefon',
    'contact.location': 'Standort',
    'contact.linkedin': 'LinkedIn',
    'contact.booking.title': 'Beratungstermin vereinbaren',
    'contact.booking.subtitle': 'Wählen Sie eine Kontaktmethode aus, um direkt eine Verbindung herzustellen',
    'contact.slot1.title': '15-Minuten Strategiegespräch',
    'contact.slot1.desc': 'Ideal für das erste Kennenlernen und die erste Bedarfsabklärung',
    'contact.slot2.title': 'Detaillierte Offertenanfrage',
    'contact.slot2.desc': 'Kostenvoranschlag, Compliance-Analyse oder Projekt-Timelines anfragen',
    'contact.book': 'Termin buchen',
    'contact.request': 'Anfragen',
    'form.name':        'Ihr Name',
    ...
    // Footer
    'footer.tagline':  'PMP® | M&E-Berater | Datenanalyse | Öffentliche Gesundheit',
    ...
    'exp.2.desc':  `<li><strong>Schulpartnerschaften:</strong> Koordination von Schulpartnerschaftsprogrammen zwischen der Schweiz und Ostafrika zur Stärkung der interkulturellen Zusammenarbeit.</li>
                    <li><strong>Programmleitung:</strong> Konzeption, Organisation und Evaluation von Workshops für Jugendführungs-Fähigkeiten in öffentlichen und privaten Schulen.</li>
    ...
    'exp.5.desc':  `<li><strong>M&amp;E-Projektleitung:</strong> Leitung der Feld-M&amp;E-Aktivitäten für kommunale Gesundheitsversorgung und sanitäre Infrastruktur.</li>
                    <li><strong>Gesundheitsschulungen:</strong> Ausbildung von Flüchtlings- und Gemeindevertretern in Fragen der Hygiene, Prävention und Umweltpflege.</li>
                    <li><strong>Bedarfsanalysen:</strong> Durchführung nationaler Erhebungen und Bereitstellung datengestützter Strategieberichte für die Geschäftsleitung.</li>`,
    ...
    'exp.7.desc':  `<li><strong>Gemeindemobilisierung:</strong> Durchführung regionaler Feldworkshops zur Einbindung der ländlichen Bevölkerung in Agrarprojekte.</li>
                    <li><strong>Projekttracking:</strong> Überwachung von Timelines und Erstellung von Leistungsberichten für USAID-Projektverantwortliche.</li>`,
    
    'exp.8.title': 'Buchhaltungsassistent',
    'exp.8.desc':  `<li><strong>Finanzkontrolle:</strong> Abwicklung der täglichen Abstimmungen, Cashflow-Überwachung und Erstellung monatlicher Bilanzen.</li>
                    <li><strong>Richtlinien-Compliance:</strong> Einhaltung strenger Save the Children UK Finanzvorschriften und internationaler Geberanforderungen garantiert.</li>`,
    ...
    'research.desc.5':  'Untersucht, wie soziokulturelle Faktoren auf Gemeindeebene die M&E-Akzeptanz bei Malariaprogrammen beeinflussen. Die Ergebnisse zeigen, dass zwar allgemeine Einstellungen keinen signifikanten Einfluss haben, wohl aber spezifische kulturelle Überzeugungen (β = .116) und lokale Entscheidungsmacht (β = .232).',
    ...
    'research.desc.7':  'Untersucht die Auswirkungen von Projektimplementierungs-Variablen auf die M&E-Nutzung bei Malariaprogrammen in Uganda. Eine multiple Regressionsanalyse von 120 Beteiligten zeigt, dass während Qualität, Kapazität und Kommunikation keinen signifikanten Einfluss haben, die Aktualität (Timeliness) der primäre Treiber ist.',
    'research.desc.8':  'Analysiert die organisatorischen Entscheidungsmerkmale, die die M&E-Nutzung beeinflussen. Die Ergebnisse zeigen, dass die Aufnahmebereitschaft des Managements und der Informationsbedarf nicht signifikant sind, während die strukturellen Merkmale der Entscheidungen selbst die Haupttreiber sind.',
    ...
    'research.desc.11': 'Qualitative Studie mit Interviews von Branchenexperten zur Untersuchung, wie digitale Marketingstrategien die Marktdurchdringung und das Geschäftswachstum im ugandischen Versicherungssektor beeinflussen.',
    ...
    'football.card2.title':    'Hauptrolle',
    ...
    'capability.differentiators.list':'<li><strong>PMP®-zertifiziert:</strong> Diszipliniertes Projektmanagement und agile Umsetzung (Agile execution).</li><li><strong>Mehrsprachig:</strong> Englisch, Deutsch (B2), Swahili und 10 afrikanische Sprachen.</li><li><strong>Evidenzbasiert:</strong> Publizierter Forscher in peer-reviewed Fachzeitschriften für öffentliche Gesundheit und digitales Marketing.</li><li><strong>Interkulturelle Beratung:</strong> Umfassende internationale Erfahrung bei der Koordination von Programmen in unterschiedlichen Kontexten.</li>',
    ...
    'capability.pos.title':           'PERRY GAMBA, PMP®',
    'capability.pos.subtitle':        'Senior Advisor für Internationale Entwicklung, Evidenzsysteme & Bildung',
    'capability.about.p1':            'PMP®-zertifizierter Berater mit mehr als 15 Jahren Erfahrung in der Unterstützung von Regierungen, NGOs, Bildungseinrichtungen und internationalen Organisationen bei der Leistungsverbesserung durch Evidenzsysteme, Datenanalysen, Programmleitung und regulatorische Compliance.',
    'capability.about.p2':            'Ich habe nationale Monitoring- und Evaluationssysteme konzipiert und implementiert, Programme für öffentliche Gesundheit und soziale Entwicklung geleitet, Wirkungsanalysen durchgeführt und private Bildungsinitiativen in der Schweiz beraten.',
    'capability.about.p3':            'Meine Arbeit verbindet strategische Planung, datengestützte Entscheidungsfindung und Organisationsentwicklung, um die Rechenschaftspflicht zu stärken, Ergebnisse zu verbessern und nachhaltiges Wachstum zu fördern.',
    'capability.practice.title':      'Beratungsschwerpunkte',
    'capability.practice.1.title':    'Evidenzsysteme & Monitoring-Architektur',
    'capability.practice.1.desc':     'Konzeption und Einführung von Systemen für Monitoring, Evaluation, Berichterstattung und Lernen (MEL) für Regierungen, NGOs, geberfinanzierte Programme und Bildungseinrichtungen.',
    'capability.practice.1.deliv':    'Lieferergebnisse: M&E-Konzepte, KPI-Architektur, Indikatorenkataloge, Berichtssysteme, Datenqualitäts-Frameworks, Dashboards',
    'capability.practice.2.title':    'Datenanalyse & Performance Intelligence',
    'capability.practice.2.desc':     'Umwandlung organisatorischer Daten in handlungsrelevante Erkenntnisse für Führung und Entscheidungsfindung.',
    'capability.practice.2.deliv':    'Lieferergebnisse: Performance-Dashboards, Daten-Audits, statistische Analysen, Datenvisualisierung, automatisierte Berichte',
    'capability.practice.3.title':    'Programmevaluation & Wirkungsanalyse',
    'capability.practice.3.desc':     'Unabhängige Bewertung der Programmwirksamkeit unter Anwendung quantitativer und qualitativer Methoden.',
    'capability.practice.3.deliv':    'Lieferergebnisse: Baseline-Studien, Zwischenevaluationen, Endevaluationen, Wirkungsanalysen, Learning Reviews',
    'capability.practice.4.title':    'Bildungsentwicklung & Regulatorische Compliance',
    'capability.practice.4.desc':     'Beratungsunterstützung für Privatschulen und Bildungsinitiativen bei der Bewältigung kantonaler regulatorischer und betrieblicher Anforderungen.',
    'capability.practice.4.deliv':    'Lieferergebnisse: Bewilligungsanträge, Compliance-Audits, Governance-Strukturen, Lehrplan 21-Abstimmung, strategische Entwicklungspläne',
    'capability.practice.5.title':    'Projekt- & Programmleitung',
    'capability.practice.5.desc':     'PMP®-konformes Projekt- und Programmmanagement.',
    'capability.practice.5.deliv':    'Lieferergebnisse: Programm-Design, Implementierungs-Support, Stakeholder-Koordination, Risikomanagement, Leistungsüberwachung',
    'capability.sectors.title':       'Zielsektoren',
    'capability.sectors.list':        '<li>Regierungsministerien</li><li>Internationale Organisationen</li><li>NGOs & Stiftungen</li><li>Öffentliche Gesundheitsprogramme</li><li>Bildungsinstitutionen</li><li>Privatschulen</li><li>Flüchtlings- & Integrationsprogramme</li><li>Gemeindeentwicklungsprojekte</li>',
    'capability.snapshot.title':      'Wirkung im Überblick',
    'capability.snapshot.metric1.lbl': 'Jahre Erfahrung',
    'capability.snapshot.metric2.lbl': 'Unterstützte Gesundheitseinrichtungen',
    'capability.snapshot.metric3.lbl': 'Ausgebildete Fachkräfte',
    'capability.snapshot.metric4.lbl': 'Leistungsverbesserung erreicht',
    'capability.snapshot.metric5.lbl': 'Master-Abschlüsse',
    'capability.snapshot.metric6.lbl': 'Betreute Kontinente',
    'capability.snapshot.metric7.lbl': 'Privatschule gegründet',
    'capability.engagements.title':    'Aktuelle Beratungsmandate',
    'capability.engagements.lernweg.title': 'LernWeg Primarschule (Gründer & Strategische Leitung)',
    'capability.engagements.lernweg.desc': '<li>Entwicklung des Schulkonzepts</li><li>Governance-Design</li><li>Finanzmodellierung</li><li>Regulatorische Planung</li>',
    'capability.engagements.lebeort.title': 'Trägerverein LebeORT Innerthal',
    'capability.engagements.lebeort.desc': '<li>Schul-Compliance-Überprüfung</li><li>Regulatorische Lückenanalyse</li><li>Vorbereitung Neueinreichung Betriebsbewilligung</li>',
    'capability.engagements.eastafrica.title': 'Schweiz–Ostafrika Schulpartnerschaften',
    'capability.engagements.eastafrica.desc': '<li>Programmkoordination</li><li>Monitoring-Konzeption</li><li>Wirkungsberichterstattung</li>',
    'capability.credentials.title':   'Qualifikationen & Referenzen',
    'capability.credentials.cert.title': 'Berufliche Zertifizierungen',
    'capability.credentials.cert.list': '<li><strong>PMP®</strong> – Project Management Institute</li><li><strong>Harvard CORe</strong> – Business School Credentials</li><li><strong>CAS Big Data Analysis</strong> – Angewandte Datenanalyse</li><li><strong>CAS Nutritional Crises</strong> – Öffentliche Gesundheitspflege</li><li><strong>USAID Systematic Reviews</strong> – Evidenzmethodik</li>',
    'capability.credentials.acad.title': 'Akademische Abschlüsse',
    'capability.credentials.acad.list': '<li><strong>MSc Data Analytics</strong></li><li><strong>MSc Public Health</strong> (International Health)</li><li><strong>Master in Projekt-Monitoring & Evaluation</strong></li><li><strong>Executive Diploma in Advanced Research</strong></li><li><strong>Bachelor of Business Administration</strong></li>',
    'capability.publications.title':  'Ausgewählte Publikationen & Forschung',
    'capability.publications.1.title': 'Soziostrukturelle und individuelle Faktoren bei HIV-Offenlegungsentscheidungen',
    'capability.publications.1.desc':  'Peer-Review-Studie zur Entscheidungsfindung in gemeindebasierten Gesundheitsprogrammen.',
    'capability.publications.2.title': 'Digitale Marketinginnovationen in Schwellenländern: Versicherungssektor',
    'capability.publications.2.desc':  'Umfassende Studie über digitale Kanäle zur Überwindung von Marktschranken.',
    'capability.publications.3.title': 'Aktualität als Haupttreiber der M&E-Nutzung bei Malariainitiativen',
    'capability.publications.3.desc':  'Regressionsanalyse zu den Faktoren für die Nutzung von M&E-Ergebnissen.',
    'capability.publications.4.title': 'Entscheidungscharakteristika und M&E-Nutzung',
    'capability.publications.4.desc':  'Organisationsanalyse zum Einfluss von Entscheidungsstrukturen auf die Evaluation.',
    'capability.references.desc':     'Berufliche Referenzen auf Anfrage erhältlich.',
    'capability.connect.title':       'Verbindung aufnehmen',
    'capability.connect.website':     'Website',
    'capability.connect.linkedin':    'LinkedIn',
    'capability.connect.email':       'E-Mail',
  }
};
...
function setLanguage(lang) {
  ...
  // Update URL parameter without reloading page for clean sharing
  ...
  // Dynamically update document title and meta description for browser/tabs
...
function initLanguage() {
  // Check URL params first (great for search bots), then local storage, default to English
  const urlParams = new URLSearchParams(window.location.search);
  const langParam = urlParams.get('lang');
  const saved = langParam || localStorage.getItem('lang') || 'en';
