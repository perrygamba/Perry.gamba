const translations = {
  en: {
    ...
    'research.desc.5':  'A cross-sectional study of 120 project personnel across 6 organisations in Mukono District. While attitude toward malaria control had no significant effect, community beliefs (β = .116, p = 0.000) and decision-making structures (β = .232, p = 0.004) were found to independently and significantly drive M&E results utilization. The study highlights the need for targeted community sensitization to overcome negative health beliefs and improve program integration.',
    ...
    'research.desc.8':  'A quantitative study analyzing 120 employees across 6 organisations in Mukono District. It demonstrates that while organisational receptiveness ($\\beta = -.085$) and information needs ($\\beta = -.251$) had no significant effect, decision characteristics ($\\beta = .696$, $p < 0.001$) strongly determine M&E findings utilization. The study advocates for systematic stakeholder identification and involvement to drive usage.',
  ...
  de: {
    ...
    'research.desc.5':  'Eine Querschnittsstudie mit 120 Projektmitarbeitenden aus 6 Organisationen im Distrikt Mukono. Während die Einstellung zur Malariabekämpfung keinen signifikanten Einfluss zeigte, wirkten sich lokale Überzeugungen (β = .116, p = 0.000) und Entscheidungsstrukturen (β = .232, p = 0.004) unabhängig und signifikant auf die M&E-Nutzung aus. Die Studie empfiehlt gezielte Sensibilisierung zur Überwindung negativer Gesundheitsüberzeugungen.',
    ...
    'research.desc.8':  'Eine quantitative Untersuchung von 120 Mitarbeitenden in 6 Organisationen im Distrikt Mukono. Sie zeigt, dass während organisationale Aufnahmebereitschaft ($\\beta = -.085$) und Informationsbedarf ($\\beta = -.251$) keinen signifikanten Einfluss hatten, die Entscheidungsmerkmale ($\\beta = .696$, $p < 0.001$) die M&E-Nutzung stark bestimmen. Empfohlen wird die systematische Einbindung von Stakeholdern.',
