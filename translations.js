const translations = {
  en: {
    ...
    'research.desc.8':  'Examines organization-level decision-making characteristics influencing M&E utilization. Findings indicate that while manager receptiveness (β = -.085) and information needs (β = -.251) are not significant factors, the structural characteristics of the decisions themselves (β = .696, p < 0.001) are the primary drivers of evaluation utilization.',
